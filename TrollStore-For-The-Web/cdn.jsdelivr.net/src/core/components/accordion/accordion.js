...
const Accordion = {
  toggleClicked($clickedEl) {
    ...
    const $accordionContent = $clickedEl
      .parents(".accordion-item-content")
      .eq(0);
    ...
    if (
      $clickedEl.parents("li").length > 1 &&
      $clickedEl.parents("li")[0] !== $accordionItemEl[0]
    )
      return;
  ...
  open(el) {
    ...
    const $openedItem =
      $list.length > 0 && $el.parent().children(".accordion-item-opened");
