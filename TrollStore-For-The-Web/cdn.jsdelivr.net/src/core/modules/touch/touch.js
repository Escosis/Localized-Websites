...
function initTouch() {
  ...
  function handleTouchStart(e) {
    ...
    isTouchMoveActivable =
      app.theme === "ios" && e.target.closest(touchMoveActivableIos);
  ...
  function handleTouchMove(e) {
    ...
    if (
      isTouchMoveActivable ||
      (!isScrolling && isSegmentedStrong && segmentedStrongEl)
    ) {
  ...
  function handleClick(e) {
    ...
    const isTouchMoveActivable =
      e && e.detail && e.detail === "f7TouchMoveActivable";
